...
if (isset($_POST['subject']) && !empty($_POST['subject']) && isset($_POST['duration']) && isset($_POST['questions'])) {
    $quiz_id = (int)$_POST['subject'];
    $duration = (int)$_POST['duration'];
    $num_questions = (int)$_POST['questions'];
    ...
    $stmt->bind_param("ii", $quiz_id, $num_questions);
    $stmt->execute();
    ...
    die("No subject selected or invalid parameters.");
}
...
<body>
    <div id="quiz-container">
        ...
        <div class="timer">
            ...
            <span id="timer"><?= sprintf('%02d:00', $duration) ?></span>
        </div>

        <form id="quizForm" method="POST" action="grade_quiz.php">
    <input type="hidden" name="quiz_id" value="<?= $quiz_id ?>"> <!-- Add this line -->
    ...
    <script>
        ...
        let timeLeft = <?= $duration * 60 ?>; // Duration in seconds
