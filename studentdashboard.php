...
if (!isset($_SESSION['student_username'])) {
    ...
    header("Location: ../studentlogin/student-login.html"); // Fixed typo here
    exit();
}
...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="quiz_history.php"><i class="fas fa-book"></i> History</a>
    </div>
  ...
  <div class="main-content">
    ...
    <div class="subject-selection">
      ...
      <div class="subject-container">
        <div class="subject-box" onclick="showQuizOptions('Operating System', 3)">
          <h5>Operating System</h5>
        </div>
        <div class="subject-box" onclick="showQuizOptions('Database Management System', 2)">
          <h5>Database Management System</h5>
        </div>
        <div class="subject-box" onclick="showQuizOptions('Scripting Language', 4)">
          <h5>Scripting Language</h5>
        </div>
        <div class="subject-box" onclick="showQuizOptions('Numerical Method', 1)">
          <h5>Numerical Method</h5>
        </div>
        <div class="subject-box" onclick="showQuizOptions('Software Engineering', 5)">
  ...
  <div class="modal fade" id="quizOptionsModal" tabindex="-1" role="dialog" aria-labelledby="quizOptionsModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="quizOptionsModalLabel">Select Quiz Options</h5>
        ...
        <div class="modal-body">
          <p id="quizSubject"></p>
          <button class="btn btn-primary mb-2" onclick="startQuiz(5, 5)">5 min for 5 questions</button>
          <button class="btn btn-primary mb-2" onclick="startQuiz(10, 10)">10 min for 10 questions</button>
          <button class="btn btn-primary" onclick="startQuiz(15, 15)">15 min for 15 questions</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function showQuizOptions(subject, quizId) {
      document.getElementById('quizSubject').innerText = `Select Duration and Number of Questions for ${subject}`;
      $('#quizOptionsModal').modal('show');
      window.selectedQuizId = quizId;
    }

    function startQuiz(duration, questions) {
      document.getElementById('selectedSubject').value = window.selectedQuizId;
      document.getElementById('selectedDuration').value = duration;
      document.getElementById('selectedQuestions').value = questions;
